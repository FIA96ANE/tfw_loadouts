...
_primaryweapon = "rhs_weap_XM2010_sa";

//primary weapon items - (array)
_itemsPrimaryweapon = ["rhsusf_acc_LEUPOLDMK4_2","rhsusf_acc_harris_bipod","rhsusf_acc_LEUPOLDMK4_2"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [15,0];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
...
_itemsBackpack = ["rhsusf_acc_rotex5_tan","rhsusf_ANPVS_15"];
