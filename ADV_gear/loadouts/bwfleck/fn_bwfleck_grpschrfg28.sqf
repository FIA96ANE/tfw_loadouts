...
//clothing - (string)
_uniform = ["PBW_Uniform1_fleck","PBW_Uniform1H_fleck","PBW_Uniform3K_fleck"];
_vest = ["BWA3_Vest_Marksman_fleck"];
_headgear = ["PBW_Helm2_fleck","PBW_Helm2_fleck_BU","PBW_Helm2_fleck_BUD","PBW_Helm1_fleck","PBW_Helm1_fleck_BO","PBW_Helm1_fleck_BOD","PBW_Helm1_fleck_BU","PBW_Helm1_fleck_BUD","PBW_Helm2_fleck_H","PBW_Helm2_fleck_HBU","PBW_Helm2_fleck_HBUD","PBW_Helm1_fleck_H","PBW_Helm1_fleck_HBO","PBW_Helm1_fleck_HBOD","PBW_Helm1_fleck_HBU","PBW_Helm1_fleck_HBUD"];
...
_goggles = ["rhs_googles_black","rhs_googles_clear","rhs_googles_yellow","rhs_googles_orange","PBW_shemagh_gruen",""];

//weapons - primary weapon - (string)
_primaryweapon = "BWA3_G28_Standard";

//primary weapon items - (array)
_itemsPrimaryweapon = ["BWA3_optic_20x50"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [11,"BWA3_10Rnd_762x51_G28_LR"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
_additionalAmmo = [1,"BWA3_10Rnd_762x51_G28_Tracer"]; //additional ammo classes up to 3: _additionalAmmo2 /_additionalAmmo3
...
_itemsVest = ["PBW_muetze1_fleck"];

//items added specifically to Backpack: - (array)
_itemsBackpack = ["dsk_nsv"];
