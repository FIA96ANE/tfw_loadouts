...
_itemsPrimaryweapon = ["HLC_Optic_ZFSG1"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [11,"hlc_20rnd_762x51_Mk316_G3"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
_additionalAmmo = [1,"hlc_20rnd_762x51_T_G3"]; //additional ammo classes up to 3: _additionalAmmo2 /_additionalAmmo3
