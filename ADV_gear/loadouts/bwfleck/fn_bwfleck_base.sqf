...
//clothing - (string)
_uniform = ["PBW_Uniform1_fleck","PBW_Uniform2_fleck"];
_vest = ["BWA3_Vest_Fleck"];
_headgear = ["BWA3_Booniehat_Fleck","H_Cap_grn","H_Cap_blk","PBW_muetze1_fleck","H_Cap_tan"];
_backpack = "";
_insignium = "";
...
_additionalAmmo = [nil,nil]; //additional ammo classes up to 3: _additionalAmmo2 /_additionalAmmo3
