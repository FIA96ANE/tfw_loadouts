...
_headgear = ["rhsusf_ach_bare_ess","rhsusf_ach_bare_headset","rhsusf_ach_helmet_ocp","rhsusf_ach_helmet_ESS_ocp","rhsusf_ach_helmet_headset_ocp","rhsusf_ach_helmet_headset_ess_ocp"];
_backpack = ["B_Kitbag_cbr","B_Kitbag_sgg"];
_insignium = "";
...
_primaryweaponAmmo = [7,"rhsusf_100Rnd_762x51"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
