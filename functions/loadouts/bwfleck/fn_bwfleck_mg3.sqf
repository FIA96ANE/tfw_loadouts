...
_backpack = ["B_BergenC_grn","B_Bergen_rgr","B_Kitbag_rgr"];
_insignium = "";
...
_primaryweapon = ["hlc_lmg_MG3KWS_b","hlc_lmg_MG3KWS_g"];

//primary weapon items - (array)
_itemsPrimaryweapon = ["BWA3_optic_ZO4x30_Single"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [6,"hlc_100Rnd_762x51_M_MG3"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
