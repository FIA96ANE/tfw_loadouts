...
_headgear = ["rhsusf_mich_helmet_marpatd_norotos_arc_headset","rhsusf_mich_helmet_marpatd_norotos_headset","rhsusf_mich_helmet_marpatd_alt_headset"];
...
_itemsBackpack = ["rhs_booniehat2_marpatd","rhsusf_ANPVS_14","rhs_8point_marpatd"];
