...
_headgear = ["rhsusf_lwh_helmet_marpatd","rhsusf_lwh_helmet_marpatd_ess","rhsusf_lwh_helmet_marpatd_headset"];
...
_primaryweapon = "rhs_weap_m27iar";

//primary weapon items - (array)
_itemsPrimaryweapon = ["rhsusf_acc_SpecterDR_D","rhsusf_acc_harris_bipod"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [18,"rhs_mag_30Rnd_556x45_Mk318_Stanag"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
...
_itemsBackpack = ["rhs_booniehat2_marpatd","rhsusf_ANPVS_14"];
