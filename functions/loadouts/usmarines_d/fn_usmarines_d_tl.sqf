...
_headgear = ["rhsusf_mich_helmet_marpatd_alt_headset"];
...
_goggles = ["rhs_googles_black","rhs_googles_clear","rhs_googles_yellow","rhs_googles_orange","","PBW_RevisionT_Klar"];

//weapons - primary weapon - (string)
_primaryweapon = "rhs_weap_m4_m203";
