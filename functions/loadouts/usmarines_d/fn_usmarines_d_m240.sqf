...
_itemsPrimaryweapon = ["rhsusf_acc_ELCAN_ard"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [5,"rhsusf_100Rnd_762x51_m993"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
...
_itemsVest = ["rhsusf_ANPVS_14"];

//items added specifically to Backpack: - (array)
_itemsBackpack = ["rhs_booniehat2_marpatd"];
