...
_itemsPrimaryweapon = ["rhsusf_acc_compm4","rhsusf_acc_anpeq15_bk_top"];
...
_itemsBackpack = ["rhs_booniehat2_marpatd","MineDetector","DemoCharge_Remote_Mag","DemoCharge_Remote_Mag","DemoCharge_Remote_Mag","rhsusf_ANPVS_14"];
