...
_itemsPrimaryweapon = ["RKSL_optic_LDS","UK3CB_BAF_LLM_Flashlight","UK3CB_BAF_sffh"];
...
_itemsBackpack = ["UK3CB_BAF_HMNVS","rhsusf_100Rnd_762x51","rhsusf_100Rnd_762x51","rhsusf_100Rnd_762x51","UK3CB_BAF_H_Beret_RM_Bootneck_PRR"];
