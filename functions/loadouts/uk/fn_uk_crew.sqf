...
//clothing - (string)
_uniform = ["UK3CB_BAF_U_CrewmanCoveralls_RTR"];
_vest = ["UK3CB_BAF_V_Osprey"];
_headgear = ["UK3CB_BAF_H_CrewHelmet_A","UK3CB_BAF_H_CrewHelmet_ESS_A"];
_backpack = "";
_insignium = "";
...
_primaryweaponAmmo = [5,"UK3CB_BAF_556_30Rnd"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
