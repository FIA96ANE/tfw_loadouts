...
//clothing - (string)
_uniform = ["UK3CB_BAF_U_HeliPilotCoveralls_RAF"];
...
_primaryweaponAmmo = [5,"hlc_30Rnd_9x19_GD_MP5"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
