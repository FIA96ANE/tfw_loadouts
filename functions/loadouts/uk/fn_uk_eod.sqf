...
_backpack = ["UK3CB_BAF_B_Bergen_MTP_Sapper_H_A","UK3CB_BAF_B_Bergen_MTP_Sapper_L_A"];
_insignium = "";
...
_itemsBackpack = ["MineDetector","DemoCharge_Remote_Mag","DemoCharge_Remote_Mag","DemoCharge_Remote_Mag","UK3CB_BAF_HMNVS","UK3CB_BAF_H_Beret_RM_Bootneck_PRR"];
