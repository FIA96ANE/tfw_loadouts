...
_headgear = ["BWA3_CrewmanKSK_Schwarz_Headset","BWA3_CrewmanKSK_Fleck_Headset","BWA3_CrewmanKSK_Tropen_Headset"];
_backpack = "";
_insignium = "";
...
_goggles = ["PBW_RevisionF_klar","G_Lowprofile","PBW_shemagh_beige"];
...
_handgunAmmo = [6,0];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
...
_itemsVest = ["dsk_nsv","BWA3_Beret_PzGren","PBW_Headset"];
