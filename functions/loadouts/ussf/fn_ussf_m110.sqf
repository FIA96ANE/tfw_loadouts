...
_itemsPrimaryweapon = ["rhsusf_acc_harris_bipod","rhsusf_acc_SR25S","RKSL_optic_PMII_312_sunshade_wdl"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [14,0];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
...
_itemsBackpack = ["rhsusf_ANPVS_15"];
