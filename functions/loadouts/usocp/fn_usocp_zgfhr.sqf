...
_headgear = ["rhsusf_ach_bare_headset","rhsusf_ach_bare_headset_ess","rhsusf_ach_helmet_headset_ocp","rhsusf_ach_helmet_headset_ess_ocp"];
...
_primaryweapon = "rhs_weap_m4a1_grip";

//primary weapon items - (array)
_itemsPrimaryweapon = ["rhsusf_acc_ACOG2","rhsusf_acc_anpeq15_bk_top"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [8,"rhs_mag_30Rnd_556x45_Mk318_Stanag"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
