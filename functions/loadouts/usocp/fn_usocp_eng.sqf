...
_headgear = ["rhsusf_ach_bare","rhsusf_ach_bare_ess","rhsusf_ach_bare_headset","rhsusf_ach_bare_headset_ess","rhsusf_ach_helmet_ocp","rhsusf_ach_helmet_ESS_ocp","rhsusf_ach_helmet_headset_ocp","rhsusf_ach_helmet_headset_ess_ocp"];
_backpack = ["B_BergenC_grn","B_Bergen_rgr","B_Kitbag_cbr"];
_insignium = "";
...
_primaryweapon = "rhs_weap_m4a1";

//primary weapon items - (array)
_itemsPrimaryweapon = ["rhsusf_acc_ACOG3"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [9,"rhs_mag_30Rnd_556x45_Mk318_Stanag"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
...
_itemsBackpack = ["rhsusf_ANPVS_14","ACE_Sandbag_empty","ACE_Sandbag_empty","ACE_Sandbag_empty","ACE_Sandbag_empty","ACE_Sandbag_empty","ACE_Sandbag_empty","ACE_Sandbag_empty","ACE_Sandbag_empty","ACE_Sandbag_empty","ACE_Sandbag_empty","Toolkit"];
