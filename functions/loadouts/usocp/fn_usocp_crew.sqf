...
_headgear = ["rhsusf_cvc_green_helmet","rhsusf_cvc_green_ess","rhsusf_cvc_helmet","rhsusf_cvc_helmet_ess"];
_backpack = "";
_insignium = "";
...
_primaryweapon = "rhs_weap_m4a1_carryhandle";
...
_primaryweaponAmmo = [5,"rhs_mag_30Rnd_556x45_Mk318_Stanag"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
