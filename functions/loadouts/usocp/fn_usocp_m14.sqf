...
_primaryweapon = "rhs_weap_m39";

//primary weapon items - (array)
_itemsPrimaryweapon = ["rhsusf_acc_LEUPOLDMK4","rhsusf_acc_harris_bipod"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [12,"rhsusf_20Rnd_762x51_m118_special_Mag"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
