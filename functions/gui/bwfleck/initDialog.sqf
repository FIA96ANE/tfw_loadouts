...
lbSetData [7377, 7, format["%1fn_bwfleck_mg4.sqf",_pfad]];
lbSetData [7377, 8, format["%1fn_bwfleck_mg5.sqf",_pfad]];
lbSetData [7377, 9, format["%1fn_bwfleck_munmg4.sqf",_pfad]];
lbSetData [7377, 10, format["%1fn_bwfleck_munmg5.sqf",_pfad]];
lbSetData [7377, 11, format["%1fn_bwfleck_off.sqf",_pfad]];
lbSetData [7377, 12, format["%1fn_bwfleck_helitiger_pilot.sqf",_pfad]];
lbSetData [7377, 13, format["%1fn_bwfleck_pio.sqf",_pfad]];
lbSetData [7377, 14, format["%1fn_bwfleck_schtz.sqf",_pfad]];
lbSetData [7377, 15, format["%1fn_bwfleck_pzfst.sqf",_pfad]];
lbSetData [7377, 16, format["%1fn_bwfleck_rgw90.sqf",_pfad]];
lbSetData [7377, 17, format["%1fn_bwfleck_flgfst.sqf",_pfad]];
lbSetData [7377, 18, format["%1fn_bwfleck_sani.sqf",_pfad]];
lbSetData [7377, 19, format["%1fn_bwfleck_zgfhr.sqf",_pfad]];
